...
## Title:        Multi-Factor Model for 100 securities in the S&P 500
...
ax1.legend()
plt.show()
fig.savefig( currentDirectory + '/Graphs/IndividualFactors_power' + powerString + '.png', dpi = 300)
...
ax1.set_title('Multi-factor performance (2010 - 2019) [ power = ' + str( power ) + ' ]', fontdict = {'size': 18, 'fontweight': 'bold'})
fig.autofmt_xdate()
ax1.plot( xDates, marketPerformance['CumulativeReturns'] ,  'black', linestyle = ':', label = 'Market' )
...
ax1.legend()
plt.show()
fig.savefig( currentDirectory + '/Graphs/MultiFactor_power' + powerString + '.png', dpi = 300)
...
performanceOutput.to_excel(currentDirectory + '/CSVs/Performance/Performance_Output_power' + powerString + '.xls')
...
plt.title('Rescaled Equal-Market-Cap Subportfolios [ power = ' + str(power) + ' ]', fontdict = {'size': 18, 'fontweight': 'bold'})
plt.savefig( currentDirectory + '/Graphs/RescaledSubs_power' + powerString + '.png', dpi = 300)
